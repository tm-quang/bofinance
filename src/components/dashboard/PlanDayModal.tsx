...
export const PlanDayModal = ({ 
  ...
  const getColorClasses = (color: string) => {
    const colorMap: Record<string, { bg: string; border: string; icon: string; gradient: string }> = {
      ...
      emerald: { bg: 'bg-gradient-to-br from-emerald-50 to-green-50', border: 'border-emerald-200/60', icon: 'bg-gradient-to-br from-emerald-400 to-emerald-500', gradient: 'from-emerald-400 to-emerald-500' },
      rose: { bg: 'bg-gradient-to-br from-rose-50 to-pink-50', border: 'border-rose-200/60', icon: 'bg-gradient-to-br from-rose-400 to-rose-500', gradient: 'from-rose-400 to-rose-500' },
      ...
      pink: { bg: 'bg-gradient-to-br from-pink-50 to-rose-50', border: 'border-pink-200/60', icon: 'bg-gradient-to-br from-pink-400 to-pink-500', gradient: 'from-pink-400 to-pink-500' },
