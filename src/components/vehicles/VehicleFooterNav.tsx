...
export function VehicleFooterNav({
    ...
    const tabs: VehicleTab[] = [
        {
            // On main page → go home (dashboard); on child pages → go to vehicle overview
            id: 'overview',
            label: isMainPage ? 'Trang chủ' : 'Tổng quan',
            icon: isMainPage ? Home : LayoutDashboard,
    ...
    const isActive = (path?: string) => {
        ...
        if (path === '/vehicles' || path === '/dashboard') return pathname === path
