/**
 * Voice to Text Page
 * Trang chuyển đổi giọng nói thành văn bản
 */

import { useState, useEffect } from 'react'
import { useNavigate } from 'react-router-dom'
import { FaMicrophone, FaCopy, FaTrash, FaEdit, FaStop, FaCheck } from 'react-icons/fa'
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4 text-xs text-slate-600">
                    <span className="flex items-center gap-1.5">
                      <span className="font-semibold text-blue-600">{text.split(/\s+/).filter((w) => w).length}</span>
                      <span>từ</span>
                    </span>
                    <span className="flex items-center gap-1.5">
                      <span className="font-semibold text-indigo-600">{text.length}</span>
                      <span>ký tự</span>
                    </span>
                  </div>
                </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <ul className="space-y-1.5 text-xs text-amber-800">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-amber-500 mt-0.5">•</span>
                    <span>Nói rõ ràng vào microphone của thiết bị</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-500 mt-0.5">•</span>
